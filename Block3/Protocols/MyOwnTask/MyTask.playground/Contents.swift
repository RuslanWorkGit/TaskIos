...
struct Robber: Rober, Cash{
    ...
    func Hide() {
        print("The robber \(name) wants to hide from superheroes")
    }
    
    func lie() {
        print("The robber \(name) lie on the floor becouse superhero assked to do it")
    }
    
    func fire() {
        print("The robber \(name) fire to the ceiling")
    }
    
    func threaten() {
        print("The robber \(name) threatens with a weapon")
    }
    
    func breakIn() {
        print("Robber \(name) push the door and came into the bank")
    }
...
struct SuperHero : BreakIn, Hero {
    var name: String
    func breakIn() {
        print("The hero \(name) break into the bank")
    }
